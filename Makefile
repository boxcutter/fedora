...
VMWARE_TEMPLATE_FILENAMES = $(filter-out fedora21-i386.json fedora21.json fedora22-i386.json fedora22.json,$(TEMPLATE_FILENAMES))
...
VIRTUALBOX_TEMPLATE_FILENAMES = $(filter-out fedora22-i386.json,$(TEMPLATE_FILENAMES))
VIRTUALBOX_BOX_FILENAMES := $(VIRTUALBOX_TEMPLATE_FILENAMES:.json=$(BOX_SUFFIX))
VIRTUALBOX_BOX_FILES := $(foreach box_filename, $(VIRTUALBOX_BOX_FILENAMES), box/virtualbox/$(box_filename))
PARALLELS_TEMPLATE_FILENAMES = $(filter-out fedora18-i386.json fedora18.json fedora20-i386.json fedora22-i386.json,$(TEMPLATE_FILENAMES))
