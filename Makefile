...
VIRTUALBOX_BOX_FILES := $(foreach box_filename fedora22-i386.json, $(BOX_FILENAMES), box/virtualbox/$(box_filename))
PARALLELS_TEMPLATE_FILENAMES = $(filter-out fedora21-i386.json fedora21.json fedora22-i386.json fedora22.json,$(TEMPLATE_FILENAMES))
